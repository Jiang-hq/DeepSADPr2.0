...
train_encodings = np.array(EGAACFeature(x_train))
test_encodings = np.array(EGAACFeature(x_ind))


x_train = train_encodings.reshape(train_encodings.shape[0],37,5)

x_ind = test_encodings.reshape(test_encodings.shape[0],37,5)
